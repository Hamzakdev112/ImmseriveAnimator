...
const About = () => {
  return (
    <div className='mt-[60px] xl:text-[16px] lg:text-[14px] text-[13px] w-[85%] mx-auto flex '>
        <div className='lg:w-[50%] w-[100%] flex flex-col gap-[1em]'>
            <div className='w-[80%] flex flex-col gap-[1em]'>
            <span className='text-[#f9c900] font-bold'>GIST OF WHAT WE DO</span>
            <h1 className='leading-[1em]	 text-[gray] text-[2em] font-extrabold'>Groundwork For Business Development</h1>
            </div>
        ...
        <div className='w-[50%]   items-center hidden lg:flex justify-center'>
